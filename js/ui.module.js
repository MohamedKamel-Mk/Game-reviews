         ...
         <div data-id="${data[i].id}"  class="card h-100 bg-transparent" role="button" ">
            <div  class="card-body">
               ...
               <figcaption>
                  ...
                  <p class="card-text small text-center opacity-50 text-bg-dark">
                     ${data[i].short_description.split(" ", 8)}
                  </p>
               </figcaption>
            </div>
            <footer class="card-footer small hstack justify-content-between">
               <span class="badge text-white">${data[i].genre}</span>
               <span class="badge text-white">${data[i].platform}</span>
            </footer>
         </div>
      </div>`;
   }
